...
module.exports = {
  ...
  theme: {
    extend: {
      fontFamily: {
        // Kept the `jakarta` alias name so this project's design tokens
        // stay 1:1 with datastaq-agency-offer even though the face is DM Sans.
      ...
      animation: {
        ...
        'dash-scroll': 'dashScroll 5s linear infinite',
